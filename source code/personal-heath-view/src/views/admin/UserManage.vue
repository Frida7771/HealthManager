    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 10px;">
            <el-row>
                <el-date-picker size="small" style="width: 220px;" v-model="searchTime" type="daterange"
                    range-separator="to" start-placeholder="start" end-placeholder="end">
                </el-date-picker>
                <el-input size="small" style="width: 188px;margin-left: 5px;margin-right: 6px;"
                    v-model="userQueryDto.userName" placeholder="input" clearable @clear="handleFilterClear">
        ...
        <el-row style="margin: 0 20px;border-top: 1px solid rgb(245,245,245);">
            <el-table @selection-change="handleSelectionChange" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="isLogin" width="108" label="ban">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip v-if="scope.row.isLogin" class="item" effect="dark"
                            content="account ban" placement="bottom-end">
                            <span style="text-decoration: underline;text-decoration-style: dashed;">ban</span>
                        </el-tooltip>
                        <span v-else>normal</span>
                    </template>
                </el-table-column>
                <el-table-column prop="isWord" width="108" label="ban comment">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip v-if="scope.row.isWord" class="item" effect="dark"
                            content="account ban comment" placement="bottom-end">
                            <span style="text-decoration: underline;text-decoration-style: dashed;">ban</span>
                        </el-tooltip>
                        <span v-else>normal</span>
                    </template>
                </el-table-column>
                <el-table-column :sortable="true" prop="createTime" width="168" label="register time"></el-table-column>
        ...
        <el-dialog :show-close="false" :visible.sync="dialogUserOperaion" width="25%">
            <div slot="title">
                <p class="dialog-title">{{ !isOperation ? 'added user' : 'edit user info' }}</p>
            </div>
            <div style="padding:0 20px;">
                ...
                <el-row>
                    ...
                    <input class="dialog-input" v-model="data.userName" placeholder="user" />
            ...
            <span slot="footer" class="dialog-footer">
                <el-button size="small" v-if="!isOperation"
                    ...
                    type="info" @click="addOperation()">new add</el-button>
            ...
            <div style="padding:0 20px;">
                <el-row>
                    <el-switch active-color="rgb(230, 62, 49)" inactive-color="rgb(246,246,246)" v-model="data.isLogin"
                        active-text="ban" inactive-text="normal">
                    </el-switch>
                </el-row>
    ...
    methods: {
        comfirmStatus() {
            ...
            this.$axios.put(`/user/backUpdate`, userUpdateDto).then(res => {
                ...
                console.log("update user status exception：" + error);
            })
        },
        handleStatus(data) {
        ...
        async handleSwitchChange(id, status, operation) {
            try {
                ...
                console.error(`update user status exception：${e}`);
            }
        },
        // 多选框选中
        ...
        async batchDelete() {
            ...
            if (confirmed) {
                try {
                    ...
                    console.error(`user info delete exception：`, e);
                }
            }
        },
        resetQueryCondition() {
        ...
        async fetchFreshData() {
            try {
                ...
                console.error('query user info exception:', error);
            }
        },
        add() {
