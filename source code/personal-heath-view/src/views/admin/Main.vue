        ...
        <el-row>
            <el-col :span="6">
                <div style="padding: 10px 5px;box-sizing: border-box;">
                    <h2 style="margin-top: 0;">latest message</h2>
            ...
            <el-col :span="18">
                <div style="box-sizing: border-box;">
                    <PieChart fontColor="rgb(51,51,51)" tag="info ratio" :values="pieValues" :types="pieTypes" />
                </div>
                <div style="display: flex;justify-content: space-evenly;">
                    <div style="box-sizing: border-box;">
                        <LineChart height="220px" tag="user count" @on-selected="userDatesSelected" :values="userValues"
                            :date="userDates" />
                    </div>
                    <div style="box-sizing: border-box;">
                        <LineChart height="220px" tag="health index" @on-selected="modelDatesSelected" :values="modelValues"
                            :date="modelDates" />
                    </div>
