    ...
    <el-row>
                ...
                <div>
                    ...
                    <div
                        ...
                        <el-button style="margin-left: 20px;" @click="saveNewsOperation" class="customer" size="mini">{{
                            !saveFlag ?
                                'collect' : 'cancel collect' }}</el-button>
                    </div>
        ...
        <el-col :span="6">
            <div v-if="scoreList.length === 0">
                <h3 style="padding: 10px 30px;">score now</h3>
            ...
            <div v-else>
                <h3 style="padding: 10px 30px;">my score</h3>
                <div style="background-color: rgb(248,249,250);margin-inline: 30px;padding: 20px;border-radius: 4px;">
            ...
            <h3 style="padding: 10px 30px;">news recommendation</h3>
    ...
    methods: {
        ...
        saveNewsOperation() {
            this.$axios.post('/news-save/operation', { newsId: this.newsInfo.id }).then(response => {
                const { data } = response;
                if (data.code === 200) {
                    this.$message.success(!this.saveFlag ? 'collect success' : 'cancel collect success');
