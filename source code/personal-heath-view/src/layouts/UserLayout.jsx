...
const menuItems = [
  { key: '/user/news-record', icon: <ReadOutlined />, label: 'news' },
  { key: '/user/my-save', icon: <BookOutlined />, label: 'my save' },
  { key: '/user/user-health-model', icon: <MedicineBoxOutlined />, label: 'health visualization' },
  { key: '/user/search-detail', icon: <SearchOutlined />, label: 'search' },
  { key: '/message', icon: <MessageOutlined />, label: 'message' },
  { key: '/record', icon: <AuditOutlined />, label: 'health record' },
];
...
const UserLayout = () => {
  ...
  const activeKey = useMemo(() => {
    ...
    return savedPath || '/user/news-record';
